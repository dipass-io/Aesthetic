...
if (window.history.pushState) {
  ...
  var timeoutHandle = null,
    ...
    tryToScrollTo = function e(t) {
      ...
      (r + scrollBarWidth - window.innerWidth >= t.x && i + scrollBarWidth - window.innerHeight >= t.y) || Date.now() > t.latestTimeToTry
    ...
    onPopState = function () {
      ...
      e &&
        Number.isFinite(e.__scrollX) &&
        Number.isFinite(e.__scrollY) &&
        setTimeout(function () {
...
!(function () {
  for (var e = 0, t = ['ms', 'moz', 'webkit', 'o'], o = 0; o < t.length && !window.requestAnimationFrame; ++o)
    (window.requestAnimationFrame = window[t[o] + 'RequestAnimationFrame']),
  ...
  (function (e, t) {
    ...
    var t,
          ...
          var r = function (o) {
            for (var n in o)
              Object.prototype.hasOwnProperty.call(o, n) &&
                (t && '[object Object]' === Object.prototype.toString.call(o[n]) ? (e[n] = c(!0, e[n], o[n])) : (e[n] = o[n]));
          };
          o < n;
          o++
        ) {
      ...
      s = function (e, t) {
        for (var o = t.charAt(0); e && e !== document; e = e.parentNode) {
          if ('.' === o && e.classList.contains(t.substr(1))) return e;
          if ('#' === o && e.id === t.substr(1)) return e;
          if ('[' === o && e.hasAttribute(t.substr(1, t.length - 2))) return e;
    ...
    (r.closeModal = function (e) {
      ...
      r &&
        (d(r, t),
        r.classList.remove(t.modalActiveClass),
        m(),
        (a = 'closed'),
        t.preventBGScroll &&
    ...
    var p = function (e, t, o) {
        if (o)
          return (
            e.removeEventListener('touchstart', c, !1), e.removeEventListener('touchend', s, !1), void e.removeEventListener('click', d, !1)
          );
      ...
      w = function (e) {
        var t = e.target,
          ...
          c = e.keyCode;
        if (c && 'open' === a) (27 === c || (n.backspaceClose && (8 === c || 46 === c))) && r.closeModal();
        else if (t) {
          if (l && !i) return;
          !o || (c && 13 !== c)
            ? 'open' === a && (e.preventDefault(), r.closeModal())
            : (e.preventDefault(), r.openModal(o, o.getAttribute('data-modal'), n));
        }
      };
    return (
      (r.destroy = function () {
  ...
  (function (e, t) {
    ...
    var e = function (t, o) {
      ...
      if (!(m.length > 0)) throw new Error("The elements you're trying to select don't exist.");
      n.elems = m;
      var p = function () {
        ...
        w = function (e) {
          var t = e.getAttribute('data-rellax-percentage'),
            ...
            a =
              n.options.vertical && (t || n.options.center)
        ...
        h = function (e, t, o) {
          var r = {},
            ...
            a = o * (100 * (1 - t));
          return (
            (r.x = n.options.round ? Math.round(i) : Math.round(100 * i) / 100),
            (r.y = n.options.round ? Math.round(a) : Math.round(100 * a) / 100),
            r
          );
        },
        y = function () {
        ...
        g = function () {
          for (var e = 0; e < n.elems.length; e++) {
            var t = (r - c[e].top + i) / (c[e].height + i),
              ...
              p =
                'translate3d(' +
                (n.options.horizontal ? f : '0') +
                'px,' +
                (n.options.vertical ? d : '0') +
                'px,' +
                m +
                'px) ' +
                c[e].transform;
      ...
      return (
        (n.destroy = function () {
          for (var e = 0; e < n.elems.length; e++) n.elems[e].style.cssText = c[e].style;
          s = !0;
        }),
        p(),
        n
  ...
  (function () {
    var e,
      ...
      d = !1,
      u = !1;
    // solución=> if (typeof offsetHeight !== 'undefined');
    ...
    'serviceWorker' in navigator &&
      ('https:' === window.location.protocol || f) &&
    ...
    var m = function (e) {
      ...
      y = function (e, t, o) {
        if (window.XMLHttpRequest) {
          ...
          (n.onreadystatechange = function () {
            if (4 === n.readyState) {
              if (200 !== n.status) return void (o && 'function' == typeof o && o(n.responseText, n));
      ...
      x = function (e) {
        if (e.querySelector('[data-content-nav]')) {
          ...
          if (o.querySelector('[data-content-nav]')) o.querySelector('[data-content-nav]').innerHTML = t.innerHTML;
          else {
      ...
      E = function (e) {
        ...
        TweenMax.to(window, i, {
          scrollTo: { y: '#' + t, offsetY: a, ease: r },
        });
      },
      A = function () {
        var e = window.innerHeight;
        TweenMax.to(window, i, { scrollTo: { y: e, offsetY: a, ease: r } });
      },
      C = function (e) {
      ...
      q = function (e) {
        ...
        if (!((t && 3 === e.which) || 2 === e.which || e.metaKey || e.ctrlKey)) {
          ...
          t && t.hasAttribute('data-scroll') && (e.preventDefault(), E(t)),
            t && t.hasAttribute('data-scroll-indicator') && (e.preventDefault(), A());
        }
      },
      M = v(function (e) {
        p();
      ...
      R = function () {
        if ('medium' === p()) {
          new Rellax('.rellax', { round: !0, vertical: !0, horizontal: !1 });
        }
      };
    history.replaceState(null, document.title, location.href),
      (document.documentElement.className = document.documentElement.className.replace('no-js', 'js')),
      h(),
      document.querySelector('[data-graphic]') && T(),
      window.addEventListener('click', q, !1),
